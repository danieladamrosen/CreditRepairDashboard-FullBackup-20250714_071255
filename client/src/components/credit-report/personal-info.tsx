          ...
          <div className={`${
            isDisputeSaved 
              ...
              : hasSelectedItems && !isDisputeSaved 
                ? 'bg-rose-50 border-2 border-red-500' 
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 justify-between items-center">
                  ...
                  <div className="flex items-center gap-2 relative overflow-visible">
                    ...
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-sm font-bold mr-1 transition-colors duration-300 ${
                    ...
                    <Button
                      onClick={() => {
                        ...
                        // If already saved, trigger re-save choreography by resetting isDisputeSaved
                        if (isDisputeSaved) {
                          console.log('GREEN SAVE BUTTON CLICKED - Triggering re-save choreography');
                          
                          // Reset and trigger choreography again
                          setIsDisputeSaved(false);
                          setTimeout(() => {
                            setIsDisputeSaved(true);
                          }, 10);
